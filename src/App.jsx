...
function App () {
  const { appData, appDataTostring, isDuplicate, handleChange, handleSubmit, handleRemoveData } = useAppData(['chickend'])
  return (
    <div className='w-full max-w-md flex flex-col gap-8 justify-center items-center'>
      ...
      <ListItemsWords listItems={appData} handleRemove={handleRemoveData} />
